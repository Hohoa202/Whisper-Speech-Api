    ...
    try:
        ...
        try:
            async with gpu_lock:
                ...
                transcribe_kwargs = {"language": whisper_language, "beam_size": 5, "word_timestamps": True, "vad_filter": vad_enabled, "condition_on_previous_text": False, "initial_prompt": "句読点（、。！？）を適切に使用して、日本語の文章として文字起こししてください。"}
